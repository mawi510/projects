...
#Rather than manually change the date range to update the season, we can add a rule
#This will simply check if today is before or after sept 1st
#If it's before, we know the season is the previous year
#Otherwise, it's the current year

# # Performance Data

#So on Jan 1st 2025, the rule will ensure that we're not attempting to pull 2025 data
#And on Sept 1st 2025, we will pull 2025 data
